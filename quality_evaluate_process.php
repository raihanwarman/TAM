<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $x1 = (test_input($_POST['poin_1_satu']) + test_input($_POST['poin_1_dua'])) /2  ;
    $x2 = (test_input($_POST['poin_2_satu']) + test_input($_POST['poin_2_dua'])) /2  ;
    $x3 = (test_input($_POST['poin_3_satu']) + test_input($_POST['poin_3_dua'])) /2  ;
    $x4 = (test_input($_POST['poin_4_satu']) + test_input($_POST['poin_4_dua'])) /2  ;
    $x5 = (test_input($_POST['poin_5_satu']) + test_input($_POST['poin_5_dua'])) /2  ;
    $x6 = (test_input($_POST['poin_6_satu']) + test_input($_POST['poin_6_dua'])) /2  ;
    $x7 = (test_input($_POST['poin_7_satu']) + test_input($_POST['poin_7_dua'])) /2  ;
    $x8 = (test_input($_POST['poin_8_satu']) + test_input($_POST['poin_8_dua'])) /2  ;
    $x9 = (test_input($_POST['poin_9_satu']) + test_input($_POST['poin_9_dua'])) /2  ;
    $x10 = (test_input($_POST['poin_10_satu']) + test_input($_POST['poin_10_dua'])) /2 ;
    $x11 = (test_input($_POST['poin_11_satu']) + test_input($_POST['poin_11_dua'])) /2;
    $x12 = (test_input($_POST['poin_12_satu']) + test_input($_POST['poin_12_dua'])) /2;
    $x13 = (test_input($_POST['poin_13_satu']) + test_input($_POST['poin_13_dua'])) /2;
    $x14 = (test_input($_POST['poin_14_satu']) + test_input($_POST['poin_14_dua'])) /2;
    $x15 = (test_input($_POST['poin_15_satu']) + test_input($_POST['poin_15_dua'])) /2;
    echo "<script type='text/javascript'>alert('Komen = $comment!');</script>";
  ...
  //                          where agent_performance_1 = '$usr'";

  $query_variable_total="select agent_performance_1.total as nilai_1,
                         agent_performance_2.total as nilai_2 FROM (agent_performance_1 inner join
                         agent_performance_2 on agent_performance_1.username = agent_performance_2.username)
                         where agent_performance_1.username = '$usr'";
  ...
  if ($periode == 1){
    $query_update_agent_performance =  "update agent_performance_1
                                        ...
                                        comment='$comment' where username='$usr'";
